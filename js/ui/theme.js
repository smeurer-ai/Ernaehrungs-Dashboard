...
export const S = {
  ...
  tab: a => ({ padding:"10px 16px", fontSize:"13px", letterSpacing:"0.1em", textTransform:"uppercase", fontFamily:"'DM Mono',monospace", background:a?"#c8a96e":"transparent", color:a?"#111":"#d4d0c8", border:"none", borderRadius:"4px 4px 0 0", cursor:"pointer", fontWeight:a?700:600, whiteSpace:"nowrap", flexShrink:0 }),
  ...
  cardTitle: { fontSize:"12px", letterSpacing:"0.14em", textTransform:"uppercase", color:"#c8a96e", fontFamily:"'DM Mono',monospace", marginBottom:"11px", fontWeight:600 },
  ...
  label: { fontSize:"13px", letterSpacing:"0.1em", textTransform:"uppercase", color:"#aaa", fontFamily:"'DM Mono',monospace", marginBottom:"5px", display:"block" },
  ...
  chip: c => ({ fontSize:"12px", padding:"3px 8px", borderRadius:"20px", background:c+"18", color:c, fontFamily:"'DM Mono',monospace", fontWeight:600 }),
  statBox: { background:"#141414", borderRadius:"8px", padding:"10px 8px", textAlign:"center", border:"1px solid #1e1e1e" },
  btn: (c="#c8a96e",tc="#111") => ({ background:c, color:tc, border:"none", borderRadius:"8px", padding:"12px 16px", fontSize:"14px", fontWeight:700, fontFamily:"'DM Mono',monospace", cursor:"pointer", letterSpacing:"0.06em" }),
  tag: c => ({ fontSize:"11px", padding:"2px 7px", borderRadius:"12px", background:c+"22", color:c, fontFamily:"'DM Mono',monospace", fontWeight:600 }),
